...
def seed():
    buildings = [ 
     ...
     {
            "bid": "C1L1",
            "name": "ทางม้าลายโรงยิมเนเซี่ยมเก่าฝั่งทิศเหนือ",
            "desc": "ทางม้าลายโรงยิมเนเซี่ยมเก่าฝั่งทิศเหนือ ทางข้ามฝั่งสนามบาสข้ามไปโรงยิมเนเซี่ยมเก่า",
            "is_node": 0,
            "lat":17.189473194769665, 
            "lng":104.09184172745555,
            "created_at": datetime.now(),
            "updated_at": datetime.now()
        },     
          {
            "bid": "C1L2",
            "name": "ทางม้าลายโรงยิมเนเซี่ยมเก่าฝั่งทิศตะวันออก",
            "desc": "ทางม้าลายโรงยิมเนเซี่ยมเก่าฝั่งทิศตะวันออก ทางข้ามฝั่งสนามบาสข้ามไปโรงยิมเนเซี่ยมเก่า",
            "is_node": 0,
            "lat":17.189321349733078, 
            "lng":104.09192932971659,
            "created_at": datetime.now(),
            "updated_at": datetime.now()
        }, 
       {
            "bid": "C1L3",
            "name": "ทางม้าลายโรงยิมเนเซี่ยมเก่าฝั่งทิศใต้",
            "desc": "ทางม้าลายโรงยิมเนเซี่ยมเก่าฝั่งทิศใต้ ทางข้ามฝั่งสนามบาสข้ามไปโรงยิมเนเซี่ยมเก่า",
            "is_node": 0,
            "lat":17.189267539241982, 
            "lng":104.09172883458389,
            "created_at": datetime.now(),
            "updated_at": datetime.now()
        }, 
                                {
            "bid": "C1L4",
            "name": "ทางม้าลายโรงยิมเนเซี่ยมเก่าฝั่งทิศตะวันตก",
            "desc": "ทางม้าลายโรงยิมเนเซี่ยมเก่าฝั่งทิศตะวันตก ทางข้ามคณะครุศาสตร์ไปฝั่งโรงยิมเนเซี่ยมเก่า",
            "is_node": 0,
            "lat":17.18945525795574, 
            "lng":104.09164994950251,
            "created_at": datetime.now(),
            "updated_at": datetime.now()
        },     
